...
> The [provisional candidate](../output/smm_runs/2026-09-07_114138/candidate.toml) is preserved
...
`output/smm_runs/`. The [current run snapshot](../output/smm_runs/2026-09-07_114138/targets.toml) was
